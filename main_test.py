...
def test_gcd():
    ...
    assert gcd([14, 28]) == 14  # Der GCD von zwei Zahlen, wobei die eine ein Vielfaches der anderen ist, ist die kleinere Zahl
    ...
    assert gcd([17]) == 17  # Nur eine Zahl in der Liste, der GCD sollte die Zahl selbst sein